...
const AdEditPhotos = props => {
  ...
  const [photos, setPhotos] = useState(picwall);
  ...
  const removePic = e =>{
    let inRemoveList = false;
    picwall.forEach(item=> {
    ...
    emitter.emit('removelist', removelist);
    //alert(e.target.src);
  }
...
AdEditPhotos.propTypes = {
  className: PropTypes.string
};

export default AdEditPhotos;
